    ...
    <div className="min-h-screen flex items-center justify-center auth-bg px-4">
      ...
      >
        ...
        <div className="mb-6">
          ...
          <p className="text-muted text-[13px] font-sans">Start collaborating with your team</p>
        </div>

        <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
          {/* Full name */}
          <div>
            <label className="block text-[13px] font-medium text-body-strong font-sans mb-1.5">Full name</label>
            <div className="relative">
              <User size={14} className="absolute left-3.5 top-1/2 -translate-y-1/2 text-muted-soft pointer-events-none" />
              <input
                {...register('name')}
          ...
          <div className="pt-1">
            ...
            >
              {isSubmitting ? 'Creating account…' : <><span>Create account</span><ArrowRight size={14} /></>}
            </motion.button>
          </div>
        </form>
        ...
        <div className="mt-6 pt-5 border-t border-hairline text-center">
          <p className="text-[13px] text-muted font-sans">
            ...
            <Link to="/login" className="text-primary hover:text-primary-active font-medium transition-colors">
              Sign in
            </Link>
          </p>
        </div>
